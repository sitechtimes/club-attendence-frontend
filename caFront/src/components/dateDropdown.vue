<template>
    <div class="dropdown" >
        ...
        <div v-if="store.datesButton == true"  class="dates uil uil-arrow-right">
  	...
  	<div class="sec-center"> 	
	  	...
	  	<label class="for-dropdown" for="dropdown" @click="store.datesButton = !store.datesButton" >{{ store.datesCurrent }}<i class="uil uil-arrow-down"></i></label>
